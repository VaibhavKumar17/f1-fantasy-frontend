                ...
                <div className="p-6 sm:p-5 flex flex-col gap-4.5 sm:gap-3.5" style={{ fontFamily: ach.fontFamily }}>
                  ...
                  <div className="flex items-center justify-between gap-2 border-b border-neutral-800 pb-3.5 sm:pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-[0.65rem] uppercase tracking-widest text-muted-foreground font-semibold">
                          Formula 1 Constructor
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 bg-secondary/30 px-3 py-1.5 rounded-md border border-neutral-800/40">
                      <Shield className="h-4 w-4" style={{ color: ach.themeColor }} />
                      <span className="text-sm sm:text-xs font-bold text-neutral-300">WCC</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 py-1">
                    <div className="bg-secondary/20 rounded-lg border border-neutral-800/40 p-2.5 text-center">
                      <span className="block text-xs sm:text-[0.6rem] text-muted-foreground uppercase tracking-widest">WCC Titles</span>
                  ...
                  <div className="border-t border-neutral-800/60 pt-3.5 flex items-center justify-between mt-1 gap-3">
                    <div className="flex flex-col text-left">
                      <span className="text-xs sm:text-[0.55rem] text-muted-foreground uppercase tracking-wider">2026 Livery preview</span>
                      <span className="text-sm sm:text-[0.65rem] font-bold text-neutral-400">₹{currentConstructor.price}M Roster Price</span>
                    </div>
                    <div className="bg-secondary/10 border border-neutral-800/45 rounded-lg px-4 py-1.5 flex items-center justify-center">
                      <ConstructorLivery constructor={currentConstructor} className="h-8 sm:h-7 w-auto object-contain" />
                    </div>
                  </div>
                </div>
              </motion.div>
