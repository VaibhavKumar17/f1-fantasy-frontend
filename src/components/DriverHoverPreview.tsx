                ...
                <div className="p-5 flex flex-col gap-3.5" style={{ fontFamily: ach.fontFamily }}>
                  ...
                  <div className="flex items-center justify-between gap-2 border-b border-neutral-800 pb-3">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className="text-sm">{currentDriver.flag}</span>
                      <span className="text-xs font-bold text-neutral-400">#{currentDriver.number}</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2.5 py-1">
                    ...
                    <div className="bg-secondary/20 rounded-lg border border-neutral-800/40 p-2 text-center">
                      <span className="block text-[0.6rem] text-muted-foreground uppercase tracking-widest">Titles</span>
                  ...
                  {/* Footer price tag */}
                  <div className="border-t border-neutral-800/60 pt-3 flex items-center justify-between text-xs text-muted-foreground mt-1">
                    <span>VALUE / LEAGUE PRICE:</span>
                    <strong className="text-accent font-racing text-sm">₹{currentDriver.price}M</strong>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
